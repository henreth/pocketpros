...
export default function BuyPacks({ user, setUser, handleBuyPackClick, handleOpenPackClick }) {
    ...
    let packsToDisplay = packTypes.map(packType => {
        return (
            <Pack key={packType} buying={true} packType={packType} user={user} setUser={setUser} handleBuyPackClick={handleBuyPackClick} handleOpenPackClick={handleOpenPackClick} />
        )
    })
